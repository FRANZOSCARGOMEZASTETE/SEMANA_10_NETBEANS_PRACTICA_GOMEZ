...
public class EJERCICIO4 {
    public static void main(String[] args) {
        ...
        cantantes.anadirCantante("Rauw Alejandro");
        cantantes.anadirCantante("Jon Z");
        cantantes.anadirCantante("Anuel");
        cantantes.anadirCantante("Noriel");
        cantantes.anadirCantante("Mike TOwers");
        cantantes.anadirCantante("Miguel Sifuentes");
        cantantes.anadirCantante("Bony Lovy");
        cantantes.anadirCantante("Italo ");
